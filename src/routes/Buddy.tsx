        ...
        <div className="buddy-grid-content">
          ...
          <div className="buddy-grid">
            <div className="buddy-card" onClick={handleBuddyCardClick}>
              <div className="buddy-card-inner">
                ...
                <div className="buddy-card-back">
                  ...
                  <a 
                    href="https://discord.gg/t4tcharlotte" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="buddy-connect-button"
                  >
                    Connect on Discord
                  </a>
                </div>
            ...
            <div className="buddy-card" onClick={handleBuddyCardClick}>
              <div className="buddy-card-inner">
                <div className="buddy-card-front">
                  <img src="/assets/corvus.png" alt="Corvus" className="buddy-image" />
                  <h3 className="buddy-name">Corvus</h3>
                  <p className="buddy-role">T4T Organizer</p>
                  <div className="buddy-hover-text">Click to learn more</div>
                </div>
                <div className="buddy-card-back">
                  <h3 className="buddy-name">Corvus</h3>
                  <div className="buddy-details">
                    <p><strong>Pronouns:</strong> He/him, E/em, It/its</p>
                    <p><strong>Bio:</strong> I've been involved in trans communities since 2017, & joined T4T in 2024. I'm passionate about a lot of things and my day job is public health/harm reduction.</p>
                    <p><strong>Location:</strong> Hickory</p>
                    <p><strong>Sexuality:</strong> Queer & Polyamorous</p>
                    <p><strong>Gender:</strong> Non-binary Transsexual Transmasc</p>
                    <p><strong>Interests:</strong> Nature, board games beadwork, reading, nail polish, tea.</p>
                    <p><strong>Quirks:</strong> Autistic and hypermobile (among other Stuff)</p>
                    <p><strong>Favorite T4T events:</strong> Board game night, book swap, craft night</p>
                  </div>
                  <a 
                    href="https://discord.gg/t4tcharlotte" 
                    target="_blank" 
            ...
            <div className="buddy-card" onClick={handleBuddyCardClick}>
              <div className="buddy-card-inner">
                <div className="buddy-card-front">
                  <img src="/assets/alex.png" alt="Alex" className="buddy-image" />
                  <h3 className="buddy-name">Alex</h3>
                  <p className="buddy-role">Welcome Buddy</p>
                  <div className="buddy-hover-text">Click to learn more</div>
                </div>
                <div className="buddy-card-back">
                  ...
                  <div className="buddy-details">
                    ...
                    <p><strong>Bio:</strong> Hey I'm Alex I suck at bios I'm very laid back and basically down for any adventure</p>
                    <p><strong>Location:</strong> Salisbury (mainly in Charlotte)</p>
                    <p><strong>Sexuality:</strong> Pansexual</p>
                    <p><strong>Gender:</strong> Agender</p>
                    <p><strong>Interests:</strong> Hikes/herbal medicine/anime</p>
                    <p><strong>Quirks:</strong> AuDHD and trouble answering open ended questions or making decisions</p>
                    <p><strong>Favorite T4T events:</strong> Board game Nights/bonfires/social suppers/ Kink 101s</p>
                  </div>
                  <a 
                    href="https://discord.gg/t4tcharlotte" 
                    target="_blank" 
        ...
        <div className="buddy-how-content">
          ...
          <div className="buddy-steps">
            ...
            <div className="buddy-step">
              ...
              <p>Connect with your chosen buddy through our Discord server where most of our community interactions happen</p>
            </div>
            <div className="buddy-step">
              <div className="step-number">3</div>
              <h3>Start Connecting</h3>
              <p>Reach out to your buddy, introduce yourself, and let them know what kind of support you're looking for</p>
            </div>
            <div className="buddy-step">
