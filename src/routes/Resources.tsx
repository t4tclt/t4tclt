          ...
          <div className="programs-grid">
            ...
            <div className="program-card">
              <div className="program-content">
                ...
                <p>Upcoming: Donation Sorting on April 16 (3:30–7 PM), Quarterly Swap + Name Change Clinic on April 19 (12–4 PM), and Plus-Sized Swap on May 7 (1–7 PM). Check the calendar or our swap page for full details and volunteer opportunities.</p>
                <a href="/swap" className="program-button">Learn More About Clothes Swaps</a>
              </div>
            </div>
